...
export interface BedrockRuntime {
     ...
     */
    invokeGuardrailChecks(args: InvokeGuardrailChecksCommandInput, options?: __HttpHandlerOptions): Promise<InvokeGuardrailChecksCommandOutput>;
    ...
    invokeGuardrailChecks(args: InvokeGuardrailChecksCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: InvokeGuardrailChecksCommandOutput) => void): void;
    /**
