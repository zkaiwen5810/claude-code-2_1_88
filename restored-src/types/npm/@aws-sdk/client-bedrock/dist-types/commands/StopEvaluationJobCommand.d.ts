...
import type { StopEvaluationJobRequest, StopEvaluationJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StopEvaluationJobCommand_base: {
    new (input: StopEvaluationJobCommandInput): import("@smithy/core/client").CommandImpl<StopEvaluationJobCommandInput, StopEvaluationJobCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StopEvaluationJobCommandInput): import("@smithy/core/client").CommandImpl<StopEvaluationJobCommandInput, StopEvaluationJobCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
