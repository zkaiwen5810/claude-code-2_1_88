...
import type { GetPromptRouterRequest, GetPromptRouterResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetPromptRouterCommand_base: {
    new (input: GetPromptRouterCommandInput): import("@smithy/core/client").CommandImpl<GetPromptRouterCommandInput, GetPromptRouterCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetPromptRouterCommandInput): import("@smithy/core/client").CommandImpl<GetPromptRouterCommandInput, GetPromptRouterCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
