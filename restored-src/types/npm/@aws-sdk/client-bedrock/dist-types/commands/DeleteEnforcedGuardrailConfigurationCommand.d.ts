...
import type { DeleteEnforcedGuardrailConfigurationRequest, DeleteEnforcedGuardrailConfigurationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteEnforcedGuardrailConfigurationCommand_base: {
    new (input: DeleteEnforcedGuardrailConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteEnforcedGuardrailConfigurationCommandInput, DeleteEnforcedGuardrailConfigurationCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteEnforcedGuardrailConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteEnforcedGuardrailConfigurationCommandInput, DeleteEnforcedGuardrailConfigurationCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
