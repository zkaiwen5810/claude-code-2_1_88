...
import type { DeleteCustomModelRequest, DeleteCustomModelResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteCustomModelCommand_base: {
    new (input: DeleteCustomModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomModelCommandInput, DeleteCustomModelCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteCustomModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomModelCommandInput, DeleteCustomModelCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
