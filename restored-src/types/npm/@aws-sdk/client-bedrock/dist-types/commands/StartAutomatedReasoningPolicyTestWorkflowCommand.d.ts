...
import type { StartAutomatedReasoningPolicyTestWorkflowRequest, StartAutomatedReasoningPolicyTestWorkflowResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartAutomatedReasoningPolicyTestWorkflowCommand_base: {
    new (input: StartAutomatedReasoningPolicyTestWorkflowCommandInput): import("@smithy/core/client").CommandImpl<StartAutomatedReasoningPolicyTestWorkflowCommandInput, StartAutomatedReasoningPolicyTestWorkflowCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartAutomatedReasoningPolicyTestWorkflowCommandInput): import("@smithy/core/client").CommandImpl<StartAutomatedReasoningPolicyTestWorkflowCommandInput, StartAutomatedReasoningPolicyTestWorkflowCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
