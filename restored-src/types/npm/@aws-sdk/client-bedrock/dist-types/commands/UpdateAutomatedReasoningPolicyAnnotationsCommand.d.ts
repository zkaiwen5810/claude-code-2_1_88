...
import type { UpdateAutomatedReasoningPolicyAnnotationsRequest, UpdateAutomatedReasoningPolicyAnnotationsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateAutomatedReasoningPolicyAnnotationsCommand_base: {
    new (input: UpdateAutomatedReasoningPolicyAnnotationsCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutomatedReasoningPolicyAnnotationsCommandInput, UpdateAutomatedReasoningPolicyAnnotationsCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateAutomatedReasoningPolicyAnnotationsCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutomatedReasoningPolicyAnnotationsCommandInput, UpdateAutomatedReasoningPolicyAnnotationsCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
