...
import type { RegisterMarketplaceModelEndpointRequest, RegisterMarketplaceModelEndpointResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const RegisterMarketplaceModelEndpointCommand_base: {
    new (input: RegisterMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<RegisterMarketplaceModelEndpointCommandInput, RegisterMarketplaceModelEndpointCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: RegisterMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<RegisterMarketplaceModelEndpointCommandInput, RegisterMarketplaceModelEndpointCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
