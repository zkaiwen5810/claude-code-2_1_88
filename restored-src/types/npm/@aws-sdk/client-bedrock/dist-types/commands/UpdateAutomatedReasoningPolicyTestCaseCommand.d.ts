...
import type { UpdateAutomatedReasoningPolicyTestCaseRequest, UpdateAutomatedReasoningPolicyTestCaseResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateAutomatedReasoningPolicyTestCaseCommand_base: {
    new (input: UpdateAutomatedReasoningPolicyTestCaseCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutomatedReasoningPolicyTestCaseCommandInput, UpdateAutomatedReasoningPolicyTestCaseCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateAutomatedReasoningPolicyTestCaseCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutomatedReasoningPolicyTestCaseCommandInput, UpdateAutomatedReasoningPolicyTestCaseCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
