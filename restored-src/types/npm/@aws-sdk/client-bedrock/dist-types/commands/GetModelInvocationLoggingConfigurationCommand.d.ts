...
import type { GetModelInvocationLoggingConfigurationRequest, GetModelInvocationLoggingConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetModelInvocationLoggingConfigurationCommand_base: {
    new (input: GetModelInvocationLoggingConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetModelInvocationLoggingConfigurationCommandInput, GetModelInvocationLoggingConfigurationCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetModelInvocationLoggingConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<GetModelInvocationLoggingConfigurationCommandInput, GetModelInvocationLoggingConfigurationCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
