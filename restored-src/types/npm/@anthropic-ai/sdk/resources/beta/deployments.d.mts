...
import * as EventsAPI from "./sessions/events.mjs";
...
export declare class Deployments extends APIResource {
     ...
     * ```
     */
    retrieve(deploymentID: string, params?: DeploymentRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<BetaManagedAgentsDeployment>;
    /**
     * Update Deployment
     *
     * @example
     ...
     * ```
     */
    update(deploymentID: string, params: DeploymentUpdateParams, options?: RequestOptions): APIPromise<BetaManagedAgentsDeployment>;
    /**
     * List Deployments
     *
     * @example
     ...
     * ```
     */
    list(params?: DeploymentListParams | null | undefined, options?: RequestOptions): PagePromise<BetaManagedAgentsDeploymentsPageCursor, BetaManagedAgentsDeployment>;
    /**
     * Archive Deployment
     *
     * @example
     ...
     * ```
     */
    archive(deploymentID: string, params?: DeploymentArchiveParams | null | undefined, options?: RequestOptions): APIPromise<BetaManagedAgentsDeployment>;
    /**
     * Pause Deployment
     *
     * @example
     ...
     * ```
     */
    pause(deploymentID: string, params?: DeploymentPauseParams | null | undefined, options?: RequestOptions): APIPromise<BetaManagedAgentsDeployment>;
    /**
     * Run Deployment Now
     *
     * @example
     ...
     * ```
     */
    run(deploymentID: string, params?: DeploymentRunParams | null | undefined, options?: RequestOptions): APIPromise<DeploymentRunsAPI.BetaManagedAgentsDeploymentRun>;
    /**
     * Unpause Deployment
     *
     * @example
     ...
     * ```
     */
    unpause(deploymentID: string, params?: DeploymentUnpauseParams | null | undefined, options?: RequestOptions): APIPromise<BetaManagedAgentsDeployment>;
}
 ...
 */
export type BetaManagedAgentsDeploymentInitialEvent = BetaManagedAgentsDeploymentUserMessageEvent | BetaManagedAgentsDeploymentUserDefineOutcomeEvent | BetaManagedAgentsDeploymentSystemMessageEvent;
/**
 * An event sent to a session immediately after it is created. Supports
 * `user.message`, `user.define_outcome`, and `system.message`.
 */
export type BetaManagedAgentsDeploymentInitialEventParams = EventsAPI.BetaManagedAgentsUserMessageEventParams | EventsAPI.BetaManagedAgentsUserDefineOutcomeEventParams | EventsAPI.BetaManagedAgentsSystemMessageEventParams;
/**
 * Why a deployment is paused. Non-null exactly when `status` is `paused`.
 */
export type BetaManagedAgentsDeploymentPausedReason = BetaManagedAgentsManualDeploymentPausedReason | BetaManagedAgentsErrorDeploymentPausedReason;
/**
...
export interface BetaManagedAgentsDeploymentUserMessageEvent {
     ...
     */
    content: Array<EventsAPI.BetaManagedAgentsTextBlock | EventsAPI.BetaManagedAgentsImageBlock | EventsAPI.BetaManagedAgentsDocumentBlock>;
    type: 'user.message';
}
/**
 ...
 */
export type BetaManagedAgentsSessionResourceConfig = BetaManagedAgentsGitHubRepositoryResourceConfig | BetaManagedAgentsFileResourceConfig | BetaManagedAgentsMemoryStoreResourceConfig;
/**
...
export interface DeploymentCreateParams {
     ...
     */
    resources?: Array<SessionsAPI.BetaManagedAgentsGitHubRepositoryResourceParams | SessionsAPI.BetaManagedAgentsFileResourceParams | SessionsAPI.BetaManagedAgentsMemoryStoreResourceParam>;
    /**
...
export interface DeploymentUpdateParams {
     ...
     */
    resources?: Array<SessionsAPI.BetaManagedAgentsGitHubRepositoryResourceParams | SessionsAPI.BetaManagedAgentsFileResourceParams | SessionsAPI.BetaManagedAgentsMemoryStoreResourceParam> | null;
    /**
     * Body param: 5-field POSIX cron schedule. Literal wall-clock matching in the
     * configured timezone.
     */
