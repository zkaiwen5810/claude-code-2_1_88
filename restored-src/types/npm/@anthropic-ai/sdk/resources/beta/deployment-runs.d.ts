...
export declare class DeploymentRuns extends APIResource {
     ...
     * ```
     */
    retrieve(deploymentRunID: string, params?: DeploymentRunRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<BetaManagedAgentsDeploymentRun>;
    /**
     ...
     * ```
     */
    list(params?: DeploymentRunListParams | null | undefined, options?: RequestOptions): PagePromise<BetaManagedAgentsDeploymentRunsPageCursor, BetaManagedAgentsDeploymentRun>;
}
 ...
 * Describes what triggered a deployment run, with trigger-specific metadata.
 */
export type BetaManagedAgentsTriggerContext = BetaManagedAgentsScheduleTriggerContext | BetaManagedAgentsManualTriggerContext;
/**
